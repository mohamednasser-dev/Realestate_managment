            ...
            <div class="row">
                <div class="form-group row">
                    ...
                    <div class="row" style="text-align:center;padding-left:375px">
                        ...
                        <div style=" padding-top:10px;font-family: 'Cairo';font-size: 22px;text-align:right"
                             class="col-sm-7">
    ...
    <div class="col-12">
        <div class="card m-b-20">
            ...
            <div class="card-body">
                ...
                <table id="datatable2" class="table table-striped  table-bordered dt-responsive nowrap" cellspacing="0"
                       width="100%">
