                    ...
                    <div class="card-body" style='text-align:right'>
                        ...
                        <div class="panel" style='text-align:right'>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" class="form-control" type="text"
                                           value="{{$client_data->getMainClient->name}}"
                                           placeholder="{{trans('admin.mainclient_name')}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" class="form-control" type="text" value="{{$client_data->name}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="check_num" class="form-control" type="text"
                                           value="{{$client_data->check_num}}"
                                           placeholder="{{trans('admin.check_num')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="check_date" id="hijri-picker" value="{{$client_data->check_date}}"
                                           type="text"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="amount" id="amount" class="form-control" type="number"
                                           value="{{$client_data->amount}}"
                                           placeholder="{{trans('admin.totalaftertaxes')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="taxepercent" id="taxe" class="form-control" type="number"
                                           value="{{$client_data->taxepercent}}"
                                           placeholder="{{trans('admin.taxepercent')}}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="total" id="total" class="form-control" type="number"
                                           value="{{$client_data->total}}" placeholder="{{trans('admin.amounts')}}"
                                           readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="part_number" class="form-control" type="text"
                                           value="{{$client_data->part_number}}"
                                           placeholder="{{trans('admin.part_number')}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="scheme_number" class="form-control" type="text"
                                           value="{{$client_data->scheme_number}}"
                            ...
                            {{--                            <div class="col-sm-9">--}}
                            <input name="id_num" class="form-control" type="hidden" value="{{$client_data->id_num}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="address" class="form-control" type="text"
                                           value="{{$client_data->address}}" placeholder="{{trans('admin.address')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="phone" class="form-control" type="number"
                                           value="{{$client_data->phone}}" placeholder="{{trans('admin.phone')}}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header" style='text-align:right'><strong> الدفعات </strong>
                    <div class="card-body" style='text-align:right'>
                        ...
                        @foreach($payments as $payment)
                            <div class="form-group row">
                                <div class="col-sm-1">
                                    <input name="rows[{{$i}}][number]" class="form-control" readonly type="number"
                                           value="{{$payment->number}}">

                                </div>
                                <div class="col-sm-3">
                                    <input name="rows[{{$i}}][name]" class="form-control" type="text"
                                           value="{{$payment->name}}" readonly>

                                </div>
                                <div class="col-sm-3">
                                    <input name="rows[{{$i}}][amount]" id="amount_one" class="form-control"
                                           type="number" value="{{$payment->amount}}"
