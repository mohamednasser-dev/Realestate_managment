                    ...
                    <table id="datatable" class="table table-striped  table-bordered dt-responsive nowrap"
                        ...
                        @foreach($reciepts as $user)
                            ...
                            <tr style='text-align:center'>
                                ...
                                <td>{{$user->desc}}</td>
                                <td>
                                    <a class='btn btn-raised btn-info btn-sml' target="_blank"
                                       href="{{url('recipts/'.$user->id)}}"><i class="fa fa-print"></i></a>
                                    @php
                                    ...
                                    @if($permission->deleteinbox == 'yes')
                                        ...
                                        <form method="get" id='delete-form-{{ $user->id }}'
                                              action="{{url('recipts/'.$user->id.'/delete')}}" style='display: none;'>
                                        {{csrf_field()}}
                                        <!-- {{method_field('delete')}} -->
                                        </form>
