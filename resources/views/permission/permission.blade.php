                            ...
                            <table style="" cellspacing="0" width="50%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label class="switch ">
                                            <input type="hidden" name="recieptsarchieve" id='recieptsarchieve'
                                                   value="no">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="operationsonclients" id='operationsonclients'
                                                   value="no">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="operationsonclientsarchieve"
                                                   id='operationsonclientsarchieve' value="no">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="clientaccountstatement"
                                                   id='clientaccountstatement' value="no">
                                ...
                                <tr>
                                    <th>صلاحية ارشيف الفرع</th>
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="branch_trans" id='branch_trans' value="no">
                                            {{ Form::checkbox('branch_trans', 'yes',  $permission->branch_trans=="yes"?true:false) }}
                                ...
                                <tr>
                                    <th>صلاحية كل الارشيف</th>
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="all_trans" id='all_trans' value="no">
                                            {{ Form::checkbox('all_trans', 'yes',  $permission->all_trans=="yes"?true:false) }}
                                ...
                                <tr>
                                    <th>صلاحية سندات الفرع</th>
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="branch_reciepts" id='branch_reciepts' value="no">
                                            {{ Form::checkbox('branch_reciepts', 'yes',  $permission->branch_reciepts=="yes"?true:false) }}
                                ...
                                <tr>
                                    <th>صلاحية كل سندات</th>
                                    <td>
                                        <label class="switch ">
                                            <input type="hidden" name="all_reciepts" id='all_reciepts' value="no">
                                            {{ Form::checkbox('all_reciepts', 'yes',  $permission->all_reciepts=="yes"?true:false) }}
