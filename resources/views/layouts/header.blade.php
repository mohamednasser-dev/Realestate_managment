                ...
                @if(session('lang')=='en')
                    <ul class="list-inline float-right mb-0">
                        @else
                            ...
                            <!-- language-->
                                <li class="list-inline-item dropdown notification-list" id="language-list">
                                ...
                                <!-- User-->
                                <li class="list-inline-item dropdown notification-list" id="notification-list">
                    ...
                    @else
                        ...
                        <!-- Navigation Menu-->
                            <ul class="navigation-menu ">
                                ...
                                <li class="has-submenu">
                                    <a href="{{url('home')}}"><i
                                            class="mdi mdi-view-dashboard"></i> {{trans('admin.dashboard')}}</a>
                                ...
                                $permission->clientaccountstatement =="yes")
                                    ...
                                    <li class="has-submenu">
                                        ...
                                        <a href="#"><i class="fa fa-users"></i> {{trans('admin.ClientandprojectList')}}
                                        </a>
                                        <ul class="submenu" style="text-align:right">
                                            @if($permission->clientsArchieve == 'yes')
                                                <li class="">
                                                    <a href="{{url('mainclient')}}"> {{trans('admin.setmainclients')}}</a>
                                ...
                                @if($permission->controllpanel == 'yes')
                                    <li class="has-submenu">
                                        <a href="#"><i class=" mdi mdi-settings"></i> {{trans('admin.Controlpanel')}}
                                        </a>
                                        <ul class="submenu" style="text-align:right">
                                            <li class="">
                                ...
                                <li class="has-submenu">
                                    <a href="#"><i class="fa fa-file"></i> {{trans('admin.transactions')}}</a>
                                    <ul class="submenu" style="text-align:right">
