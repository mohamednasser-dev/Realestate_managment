...
<div class="left side-menu">
    ...
    <div class="topbar-left">
        <div class="">
            ...
            <a href="index" class="logo"><img src="{{asset('public/uploads/posts')}}" height="70"
                                              alt="logo"></a>
        </div>
    </div> 
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{url('/admin')}}" class="waves-effect"><span> {{trans('admin.dashboard')}}</span><i
                            class=" mbri-edit"></i></a>
                </li>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><span> {{trans('admin.ClientandprojectList')}} </span> <i class="mbri-edit"></i></a>
                ...
                @if($permission->websitepanel == 'yes')
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><span> {{trans('admin.websiteControll')}} </span> <i class="mbri-edit"></i></a>
                        <ul class="list-unstyled">
                            <li class="">
                ...
                @if($permission->controllpanel == 'yes')
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><span> {{trans('admin.Controlpanel')}} </span> <i class="mbri-edit"></i></a>
                        <ul class="list-unstyled">
                            <li class="">
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><span> {{trans('admin.transactions')}} </span> <i class="mbri-edit"></i></a>
                    <ul class="list-unstyled">
