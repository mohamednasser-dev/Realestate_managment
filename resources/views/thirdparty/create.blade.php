        ...
        <div class="card m-b-20">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <!-- <label for="example-search-input" class="col-sm-2 col-form-label"></label> -->
                    <div class="col-sm-12">
                        <input name="email" class="form-control" type="text" value="{{old('email')}}" placeholder="{{trans('admin.email')}}" >
                    </div>
                </div>
                <div class="form-group row">
                    <!-- <label for="example-search-input" class="col-sm-2 col-form-label"></label> -->
                    <div class="col-sm-12">
                        <input name="mobile" class="form-control" type="number" value="{{old('mobile')}}" placeholder="{{trans('admin.mobile')}}" >
                    </div>
                </div>
