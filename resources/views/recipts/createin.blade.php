        ...
        <div class="col-7">
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2">{{trans('admin.taxepercent')}}</label>

                        <div class="col-sm-10">
                            <input name="taxepercent" id="taxepercent" class="form-control" type="number" value="{{old('taxepercent')}}"
                                   placeholder="{{trans('admin.taxepercent')}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="example-text-input"
                               class="col-sm-2 col-form-label">مبلغ السند بالضريبة</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="example-text-input"
                               class="col-sm-2 col-form-label">اجمالى المبلغ بدون الضريبه</label>
                        <div class="col-sm-10">
                            <input name="total" id="withouttaxe" class="form-control" type="number"
                                   value="{{old('total')}}" placeholder="اجمالى المبلغ بدون الضريبه" readonly>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="example-text-input"
                               class="col-sm-2 col-form-label">اجمالى مبلغ  الضريبه</label>
                        <div class="col-sm-10">
                            <input name="amount3" id="withtaxe" class="form-control" type="number"
                                   value="{{old('amount3')}}" placeholder="اجمالى مبلغ  الضريبه" readonly>
                        </div>
                    </div>
    ...
    <script>
        $(function () {
            $("#client").on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        var percent = html.data_project.taxepercent;
            ...
            $("#amount").on('change', function () {
                ...
                var taxepercent = document.getElementById("taxepercent").value;

                // var taxeamount = amount * taxepercent/100  ;
                // var amountwithouttaxe =amount - taxeamount ;

                var amountwithouttaxe = amount / (1+taxepercent / 100);
                var taxeamount = amount - amountwithouttaxe;

                $('#withtaxe').val(Math.ceil(taxeamount));
                $('#withouttaxe').val(Math.ceil(amountwithouttaxe));
